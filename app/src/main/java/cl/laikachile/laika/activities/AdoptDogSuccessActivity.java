...
public class AdoptDogSuccessActivity extends BaseActivity {
    ...
    public int yDelta;
	 ...
	 public void setActivityView(View view) {
         ...
         ImageView backgroundImageView = (ImageView) view.findViewById(R.id.picture_adopt_dog_success_imageview);
		 ...
		 ImageResponse response = new ImageResponse(this, backgroundImageView);
		 RequestManager.imageRequest(mDog.mUrlImage,backgroundImageView, response, response);
	 }
