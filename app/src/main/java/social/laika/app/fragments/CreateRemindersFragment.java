 ...
 */
public class CreateRemindersFragment extends Fragment {
    ...
    public CreateRemindersFragment() {
    }

    public static final CreateRemindersFragment newInstance(int dogId)
    {
        CreateRemindersFragment f = new CreateRemindersFragment();
    ...
    public static final CreateRemindersFragment newInstance(int dogId, int reminderId, String key)
    {
        CreateRemindersFragment f = new CreateRemindersFragment();
